 ...
 * @param {string} opts.coin[='xmcc'] - The coin for this wallet (monoeci).
 ...
 * @param {string} opts.coin[='xmcc'] - The expected coin for this wallet (monoeci).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['xmcc'], value.toLowerCase());
    },
  }];
