...
function Insight(opts) {
  ...
  this.apiPrefix = _.isUndefined(opts.apiPrefix)? '/insight-api-monoeci' : opts.apiPrefix;
  this.coin = opts.coin || Defaults.COIN;
  this.network = opts.network || 'livenet';
  this.hosts = opts.url;
  this.userAgent = opts.userAgent || 'bws';
  this.shouldTranslateAddresses = _.isUndefined(opts.translateAddresses) ? this.coin == 'xmcc' : opts.translateAddresses;
...
/**
 * Broadcast a transaction to the monoeci network
 */
...
/**
 * Broadcast a instantsend transaction to the monoeci network
 */
...
Insight.prototype.getTransactions = function(addresses, from, to, cb) {
  ...
  this.requestQueue.push(args, function(err, res, txs) {
    ...
    // NOTE: Whenever Insight breaks communication with monoecid, it returns invalid data but no error code.
